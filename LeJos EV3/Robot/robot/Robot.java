...
import lejos.utility.Delay;
	...
	/**
	 * Classe principale qui gère le comportement du robot LEGO EV3 
	 * en utilisant les modules Sensors et Actionneurs.
	 * 
	 * Cette classe sert de point d'entrée au programme et gère 
	 * l'exécution des actions en fonction des données des capteurs.
	 * Elle prend des décisions sur les mouvements et la manipulation 
	 * des objets en fonction des informations de l'environnement.
	 * 
	 * Relations avec d'autres modules :
	 * - Utilise le module Sensors pour récupérer les données des capteurs.
	 * - Utilise le module Actionneurs pour effectuer des actions en 
	 * fonction des données des capteurs.
	 * 
	 * Modules utilisés par ce module :
	 * - Sensors : Utilisé pour obtenir les informations sur les capteurs
	 * (distance, contact, couleur).
	 * - Actionneurs : Utilisé pour exécuter les mouvements du robot et 
	 * la manipulation des objets.
	 * 
	 * Modules utilisant ce module :
	 * - Aucune, cette classe est le point d'entrée principal de l'application.
	 * 
	 * Définitions de types :
	 * - `Sensors` : La classe est instanciée pour récupérer les données
	 * des capteurs.
	 * - `Actionneurs` : La classe est instanciée pour envoyer des commandes
	 * aux moteurs.
	 * 
	 * Procédures externes :
	 * - `main(String[] args)` : Point d'entrée principal du programme.
	 * - `run()` : Démarre l'exécution des actions basées sur les capteurs.
	 * 
	 * Variables externes :
	 * - Aucune variable publique, elle orchestre l'exécution à
	 * travers les modules Sensors et Actionneurs.
	 * 
